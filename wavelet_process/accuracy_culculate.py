...
def data_information_plot(loss_information, number, depression=True):
    ...
    for i in range(number):
        if depression:
            if new_infor_list[i] >= 81:
                true_number += 1
                infor_list.append((1, 1))
            else:
                infor_list.append((1, 0))
        else:
            if new_infor_list[i] < 81:
                true_number += 1
                infor_list.append((0, 0))
            else:
                infor_list.append((0, 1))
...
if __name__ == '__main__':
    config = ConfigSet(
        ...
        val_original_depression_data_root=r"G:\python_program\brain_relate_net\middle_information\original_save_wavelet_list.pt",
        ...
        val_control_depression_data_root=r"G:\python_program\neuro_network_information\brain_relate_net\middle_information\control_save_wavelet_list_200epoch.pt",
        val_original_depression_data_name='original_save_wavelet_list',
        val_depression_depression_data_name='depression_save_wavelet_list_200epoch',
        val_control_depression_data_name='control_save_wavelet_list_200epoch',
        val_depression_number=5,

        val_original_control_data_root=r"G:\python_program\brain_relate_net\middle_information\original_control_wavelet_list.pt",
        ...
        val_original_control_data_name='original_control_wavelet_list',
        val_depression_control_data_name='depression_control_save_wavelet_list_200epoch',
        val_control_control_data_name='control_control_save_wavelet_list_200epoch',
        ...
        test_depression_depression_data_root=r"G:\python_program\neuro_network_information\brain_relate_net\test_information\test_depression_depression_save_wavelet_list_200epoch.pt",
        ...
        test_control_control_data_root=r"G:\python_program\neuro_network_information\brain_relate_net\test_information\test_control_control_save_wavelet_list_200epoch.pt",
    ...
    original_cA_data = torch.cat(
        [each[0] for each in original_data[config['val_original_depression_data_name']]], dim=0).view(-1, 8,
                                                                                                       128,
                                                                                                       1255).cpu()
    original_cD_data = torch.cat(
        [each[1] for each in original_data[config['val_original_depression_data_name']]], dim=0).view(-1, 8,
                                                                                                       128,
                                                                                                       1255).cpu()
